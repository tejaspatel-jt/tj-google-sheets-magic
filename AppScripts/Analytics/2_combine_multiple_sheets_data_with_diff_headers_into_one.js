...
function mergeSheetsByHeaders() {
  ...
  // 4. Auto-fill Company Country if needed (can comment out if not needed)
  autoFillCompanyCountry(outSheet, allHeaders);

  // 5. Create Filter_CombinedData sheet
  createFilterCombinedDataSheet(ss, allHeaders);
...
// 3. Auto-fill Company Country based on Company City mapping
...
// 4. Create Filter_CombinedData sheet with vertical headers and checkboxes
